...
def init_db():
    ...
    with get_db() as conn:
        ...
        # Backward-compatible migration for databases created before persistent
        # database-backed media storage was introduced. Existing rows are kept;
        # their binary data remains NULL until a new upload replaces them.
        cursor.execute("""
            SELECT 1
